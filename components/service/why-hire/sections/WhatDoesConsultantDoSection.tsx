...
const WhatDoesConsultantDoSection = () => {
  return (
    <div className="w-full space-y-16 py-16">
      <section className="border-t-2 border-white pt-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
          <div className="lg:col-span-2">
            <h2 className="text-3xl sm:text-4xl lg:text-4xl font-extrabold uppercase text-white tracking-tighter leading-tighter text-center lg:text-left">
      ...
      <section className="pt-8 grid grid-cols-1 lg:grid-cols-5 gap-10">
