            ...
            <section className="border-t-2 border-white pt-8">
                <div className="grid grid-cols-1 gap-10 lg:grid-cols-5 lg:items-start">
                    <div className="lg:col-span-2">
                        <h2 className="text-2xl lg:text-3xl xl:text-4xl font-extrabold uppercase tracking-tight text-white text-center lg:text-left">
                            Is Hiring a College Counselor Worth It?
                        </h2>
                    </div>
                    <div className="lg:col-span-3">
                        <p className="text-sm lg:text-base leading-tight text-white">
                        ...
                        <div className="mt-10 space-y-8">
                            {highlights.map((item) => (
                                <div key={item} className="border-t border-[#9FB19F] pt-6">
                                    <p className="text-lg font-semibold text-white lg:text-xl !leading-tight">
                                        {item}
                                    </p>
                                </div>
                            ))}
